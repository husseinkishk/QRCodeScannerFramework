#
#  Be sure to run `pod spec lint QRCodeScannerFramework.podspec' to ensure this is a
...
This QRCodeScanner changes its color gradually makes your app look fantastic!
  ...
  s.author             = { "Hussein Kishk" => "hussein.kishk@code95.info" }
  # Or just: s.author    = "Hussein Kishk"
  # s.authors            = { "Hussein Kishk" => "hussein.kishk@code95.info" }
  # s.social_media_url   = "http://twitter.com/Hussein Kishk"
